...
def twig(angle, length, curr_pos, direction):
    angle_x = length * math.cos(direction) + random.uniform(0, 1)
    angle_y = length * math.sin(direction) + random.uniform(0, 1)
    ...
    if length > 5:
        ...
        twig(angle, new, next_position, direction+angle)
        twig(angle, new, next_position, direction+angle/2)
        twig(angle, new, next_position, direction-angle/2)
